...
public class Sector {
    ...
    public boolean inside(int v) {
     ...
     public boolean notOutside(int v) {
        if (!this.convex()) {
            return HelperFunctions.isRight(this.apex, this.l, v, vlib) != -1
                    && HelperFunctions.isRight(this.apex, this.r, v, vlib) != 1;
        } else {
    ...
    public boolean outside(Edge edge) {
        if (this.convex()) {
            return HelperFunctions.isRight(this.apex, this.l, edge.getL(), vlib) != 1 && HelperFunctions.isRight(this.apex, this.l, edge.getR(), vlib) != 1
            ...
            return HelperFunctions.isRight(this.apex, this.r, edge.getL(), vlib) != -1 && HelperFunctions.isRight(this.apex, this.r, edge.getR(), vlib) != -1;
        } 
