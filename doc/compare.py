...
def compare(path, verticenumber, friciton, poly, lcpLos, cellsize, maxdist):
	...
	general.runalg("qgis:randompointsinlayerbounds",poly,100,cellsize,path +"random_targets.shp")
	...
	general.runalg("gdalogr:rastercalculator",path+"cumul_cost.tif","1",None,"1",None,"1",None,"1",None,"1",None,"1","A*"+str(cellsize),"99999",5,"",path+"corrected.tif")
...
data = [["directed/squares_sp.shp", "id_2", 0.05, 0.05,10000],["corine/large_sp.shp", "Level3", 25,70,200000],["melu/melu_sp.shp", "melu", 1,10000,207800],["saaristo/saaristo.shp", "friction",25,5000,200000],["suomi/suomi_sp.shp", "VUOKRAASUN",1000,50000,200000], ["uniform/uniform.shp", "id", 0.01, 1000,1000]] #add maxdist and vnumber

lcpLos ="/home/elias/Documents/kandi/lcpLos/lcpLos/dist/lcpLos.jar"
path = "tmp"
verticenumber = 207715
...
def compareAll(data):
	...
	for i in xrange(0, len(data)):
		...
		maxdist = d[3]
		verticenumber = d[4]
		pp = compare(path+str(i)+"/", verticenumber, friciton, orig, lcpLos, cellsize, maxdist)
